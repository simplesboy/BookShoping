    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><span class="logo-word">书香阁</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="a-color" id="personInfor" href="${pageContext.request.contextPath}/information">个人信息</a></li>
                    <li class="dropdown"><a class="a-color" href="${pageContext.request.contextPath}/info/list"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="${pageContext.request.contextPath}/chatrobot">小格子</a></li>
                        </ul></li>
                </ul>
